            ...
            <table class="table table-striped table-hover align-middle">
                ...
                <tbody>
                    ...
                    foreach ($results as $result) {
                        ...
                        echo '<div id="update-form' . $result['id_transaction'] . '" class="">
                        <form action="update_transaction.php" method="POST" id="update-form" class="update-form form-submit" data-form-id="' . $result['id_transaction'] . '?>" >
                                ...
                                <button type="submit" class="btn btn-primary btn-lg" data-task-id="' . $result['id_transaction'] . '?>">Mettre à jour</button>
                                </div>
                            </form>
                        </div>';
